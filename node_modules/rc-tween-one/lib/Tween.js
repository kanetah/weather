...
p.getComputedStyle = function () {
  ...
  if (this.isSvg && style.transform === 'none') {
    ...
    this.svgComputedStyle = (0, _extends3['default'])({}, style);
    return this.svgComputedStyle;
  }
  return style;
};
p.getAnimStartData = function (item) {
  ...
  Object.keys(item).forEach(function (_key) {
    if (_key in _plugins2['default'] || _this4.attr === 'attr' && (_key === 'd' || _key === 'points')) {
    ...
    if (_this4.attr === 'attr') {
      ...
      if (_key.match(/color/i) || _key === 'stroke' || _key === 'fill') {
        ...
        start[_key] = unit !== item[_key].unit ? (0, _util.startConvertToEndUnit)(_this4.target, _key, parseFloat(data), unit, item[_key].unit) : parseFloat(data);
      }
      return;
    }
...
p.setAnimData = function (data) {
  ...
  Object.keys(data).forEach(function (key) {
    if (key in _plugins2['default'] || _this5.attr === 'attr' && (key === 'd' || key === 'points')) {
      return;
    }
...
p.setRatio = function (ratio, endData, i) {
  ...
  Object.keys(endData.vars).forEach(function (_key) {
    if (_key in _plugins2['default'] || _this6.attr === 'attr' && (_key === 'd' || _key === 'points')) {
    ...
    if (_this6.attr === 'attr') {
      ...
      if (!endVars.type) {
        ...
        _this6.target.setAttribute(_key, (0, _styleUtils.getColor)(data));
      }
    }
  });
...
p.render = function () {
  ...
  this.defaultData.forEach(function (item, i) {
    ...
    //  精度损失，只取小数点后10位。
    var progressTime = (0, _styleUtils.toFixed)(_this7.progressTime - initTime);
    ...
    if (progressTime + fromDelay >= 0) {
      if (!_this7.start[i]) {
        ...
        if (progressTime < _this7.perFrame) {
          ...
          _this7.setRatio((0, _styleUtils.toFixed)(ratio), item, i);
    ...
    if (progressTime > -_this7.perFrame && !(progressTime > duration && item.mode === 'onComplete') && _this7.start[i]) {
      ...
      if (!updateAnim) {
        _this7.onChange((0, _extends3['default'])({
